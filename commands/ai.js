...
module.exports = {
  ...
  description: 'Complete AI assistant',
  ...
  buildPrecisePrompt(prompt, previousResponse, previousPrompt, requestType) {
    ...
    if (requestType === 'summarize') {
      ...
      finalPrompt += `Give a complete and detailed answer. Include the full process, steps, and equations if applicable.\n`;
    } else {
