// ========== ai.js - COMPLETE AI ASSISTANT v33.3.0 ==========
// Dynamic Items: Kumpleto lahat ng subjects, walang duplicate
...
module.exports = {
  ...
  description: 'Complete AI assistant with dynamic detailed output',
  ...
  async handleWordList(senderId, prompt, token) {
    try {
      ...
      finalPrompt += '7. Group by category if applicable.\n';
      finalPrompt += '8. **BE COMPREHENSIVE. Give AS MANY items as the word has. Do NOT limit to a specific number. 20, 30, 50 items if possible.**\n';
  ...
  buildFollowUpPrompt(action, previousResponse, userCommand) {
    ...
    prompt += '8. **ALWAYS INCLUDE THE FINAL ANSWER at the end.**\n';
    prompt += '9. **If the original response is a MATH SOLUTION, keep the step-by-step solution AND the final answer.**\n';
    prompt += '10. NO emojis, NO markdown, NO LaTeX.\n\n';
  ...
  async callAPI(prompt, originalPrompt, language, intent, topic, subject, requestType) {
    ...
    if (bestResponse) {
      console.log('[API] Best from ' + bestApiName + ' (score: ' + bestScore + ')');
      return bestResponse;
    }
  ...
  applyUniversalFormat(response, originalPrompt, language, intent, topic, subject, requestType) {
    ...
    const briefIntents = ['definition', 'general', 'explanation', 'process', 'list', 'comparison', 'howto', 'proscons', 'importance', 'effects', 'biography', 'wordlist', 'followup', 'elaborate', 'paraphrase', 'simplify', 'expand', 'correct', 'formalize', 'construct', 'definition_process'];
  ...
  validateResponseQuality(response, intent) {
    ...
    if (sentences.length >= 15) score += 5;
    ...
    if (intent === 'definition') {
      ...
      if (points >= 5) score += 15;
      else if (points >= 3) score += 10;
  ...
  buildDefinitionProcessPrompt(prompt, langName) {
    ...
    finalPrompt += '5. Be ACCURATE and PRECISE. Verify each fact before writing. Do NOT hallucinate.\n';
    finalPrompt += '6. **BE COMPREHENSIVE. Cover ALL stages/phases/steps. Do NOT limit yourself to a specific number. Give AS MANY as the topic requires — 5, 8, 12, 20, or more.**\n';
    finalPrompt += '7. **Be DETAILED. Each item should have 1-2 sentences explanation.**\n';
    finalPrompt += '8. Answer ONLY what is asked. Do NOT add unrelated sections.\n';
    finalPrompt += '9. Do NOT pad with generic filler. Every sentence must add value.\n';
    ...
    if (isCycle) {
      ...
      finalPrompt += 'II. KEY CHARACTERISTICS\n[List ALL characteristics. Walang limit — 5, 8, 12 if needed.]\n\n';
      finalPrompt += 'III. CYCLE STAGES / PROCESSES\n';
      finalPrompt += 'Stage 1: [name]\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 2: [name]\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 3: [name]\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 4: [name]\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 5: [name] (if applicable)\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 6: [name] (if applicable)\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 7: [name] (if applicable)\n[1-3 sentences description]\n';
      finalPrompt += 'Stage 8: [name] (if applicable)\n[1-3 sentences description]\n';
      finalPrompt += '(Add MORE if needed — walang limit)\n\n';
      finalPrompt += 'IV. IMPORTANCE\n[List ALL reasons. Walang limit.]\n\n';
      finalPrompt += 'V. SUMMARY\n[2-3 sentences summary of the cycle]\n\n';
    } else {
      finalPrompt += 'FORMAT (PROCESS / STEPS):\n';
      finalPrompt += 'I. DEFINITION\n[2-4 sentences definition]\n\n';
      finalPrompt += 'II. KEY CHARACTERISTICS\n[List ALL characteristics. Walang limit.]\n\n';
      finalPrompt += 'III. PROCESSES / STEPS\n';
      finalPrompt += '1. [step]\n[1-2 sentences description]\n';
      finalPrompt += '2. [step]\n[1-2 sentences description]\n';
      finalPrompt += '3. [step]\n[1-2 sentences description]\n';
      finalPrompt += '4. [step]\n[1-2 sentences description]\n';
      finalPrompt += '5. [step]\n[1-2 sentences description]\n';
      finalPrompt += '6. [step] (if applicable)\n[1-2 sentences description]\n';
      finalPrompt += '7. [step] (if applicable)\n[1-2 sentences description]\n';
      finalPrompt += '8. [step] (if applicable)\n[1-2 sentences description]\n';
      finalPrompt += '(Add MORE if needed — walang limit)\n\n';
      finalPrompt += 'IV. EXAMPLES\n[List ALL examples. Walang limit.]\n\n';
      finalPrompt += 'V. IMPORTANCE\n[List ALL reasons. Walang limit.]\n\n';
      finalPrompt += 'VI. SUMMARY\n[2-3 sentences summary]\n\n';
    }
    finalPrompt += 'QUESTION: ' + prompt + '\n\n';
    finalPrompt += 'Complete answer:';
    return finalPrompt;
  },
  ...
  buildBriefPrompt(prompt, langName, intent) {
    ...
    finalPrompt += '2. Do NOT write a thesis or research paper.\n';
    ...
    finalPrompt += '7. **BE COMPREHENSIVE. Cover EVERY important point. Do NOT limit yourself to a specific number. Give AS MANY items as the topic requires — 5, 10, 15, 20, or more.**\n';
    finalPrompt += '8. **Be DETAILED. Each item should have 1-2 sentences explanation.**\n';
    finalPrompt += '9. **Do NOT pad with generic filler. Every sentence must add value.**\n';
    finalPrompt += '10. **ALWAYS END WITH A COMPLETE ANSWER. Do NOT cut off mid-sentence.**\n';
    finalPrompt += '11. NO emojis, NO markdown, NO LaTeX.\n';
    finalPrompt += '12. Respond in ' + langName.toUpperCase() + ' language.\n\n';

    if (intent === 'definition') {
      finalPrompt += 'TASK: Give a COMPLETE, DETAILED DEFINITION.\n\n';
      finalPrompt += 'FORMAT (I-ayon ang bilang ng items sa topic):\n\n';
      finalPrompt += 'I. DEFINITION\n[2-4 sentences definition]\n\n';
      finalPrompt += 'II. KEY CHARACTERISTICS\n[List ALL key characteristics. Give 1-2 sentences explanation each. Walang limit — kung 15 ang kailangan, 15 ang ibigay.]\n\n';
      finalPrompt += 'III. TYPES / FORMS\n[List ALL types. Walang limit.]\n\n';
      finalPrompt += 'IV. EXAMPLES\n[List ALL important examples. Walang limit.]\n\n';
      finalPrompt += 'V. IMPORTANCE\n[List ALL reasons why it matters. Walang limit.]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else if (intent === 'process') {
      finalPrompt += 'TASK: Explain the COMPLETE PROCESS.\n\n';
      finalPrompt += 'FORMAT (I-ayon ang bilang ng steps sa process):\n\n';
      finalPrompt += 'I. OVERVIEW\n[2-3 sentences overview]\n\n';
      finalPrompt += 'II. FULL PROCESS / STEPS\n[List ALL steps. Give 1-2 sentences explanation each. Walang limit — kung 12 steps ang kailangan, 12 ang ibigay.]\n\n';
      finalPrompt += 'III. KEY FACTORS\n[List ALL factors. Walang limit.]\n\n';
      finalPrompt += 'IV. IMPORTANCE\n[List ALL reasons. Walang limit.]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else if (intent === 'explanation') {
      finalPrompt += 'TASK: Explain COMPLETELY and in DETAIL.\n\n';
      finalPrompt += 'FORMAT:\n\n';
      finalPrompt += 'I. DIRECT ANSWER\n[2-3 sentences]\n\n';
      finalPrompt += 'II. DETAILED EXPLANATION\n[3-5 paragraphs. Walang limit sa haba basta kumpleto.]\n\n';
      finalPrompt += 'III. KEY POINTS\n[List ALL key points. Walang limit.]\n\n';
      finalPrompt += 'IV. EXAMPLES\n[List ALL important examples. Walang limit.]\n\n';
      finalPrompt += 'V. IMPORTANCE\n[List ALL reasons. Walang limit.]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else if (intent === 'list') {
      ...
      finalPrompt += 'II. COMPLETE LIST\n[List ALL items. Give 1 sentence explanation each. Walang limit — kung 30 items ang kailangan, 30 ang ibigay.]\n\n';
      ...
      finalPrompt += 'FORMAT:\n\n';
      finalPrompt += 'I. INTRODUCTION\n[1-2 sentences]\n\n';
      finalPrompt += 'II. DEFINITION OF EACH\n[definition of each item]\n\n';
      finalPrompt += 'III. SIMILARITIES\n[List ALL similarities. Walang limit.]\n\n';
      finalPrompt += 'IV. DIFFERENCES\n[List ALL differences. Walang limit.]\n\n';
      finalPrompt += 'V. ADVANTAGES AND DISADVANTAGES\n[Complete comparison]\n\n';
      ...
      finalPrompt += 'FORMAT:\n\n';
      finalPrompt += 'I. INTRODUCTION\n[1-2 sentences]\n\n';
      finalPrompt += 'II. MATERIALS NEEDED\n[List ALL materials. Walang limit.]\n\n';
      finalPrompt += 'III. STEP-BY-STEP GUIDE\n[List ALL steps. Give 1-2 sentences explanation each. Walang limit.]\n\n';
      finalPrompt += 'IV. TIPS AND WARNINGS\n[List ALL tips. Walang limit.]\n\n';
      finalPrompt += 'V. CONCLUSION\n[1-2 sentences]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else if (intent === 'proscons') {
      finalPrompt += 'TASK: Give COMPLETE PROS AND CONS.\n\n';
      finalPrompt += 'FORMAT:\n\n';
      finalPrompt += 'I. INTRODUCTION\n[1-2 sentences]\n\n';
      finalPrompt += 'II. ADVANTAGES\n[List ALL advantages. Walang limit.]\n\n';
      finalPrompt += 'III. DISADVANTAGES\n[List ALL disadvantages. Walang limit.]\n\n';
      finalPrompt += 'IV. BALANCED VIEW\n[2-3 sentences]\n\n';
      finalPrompt += 'V. CONCLUSION\n[1-2 sentences]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else if (intent === 'importance') {
      finalPrompt += 'TASK: Explain the IMPORTANCE COMPLETELY.\n\n';
      finalPrompt += 'FORMAT:\n\n';
      finalPrompt += 'I. DIRECT ANSWER\n[1-2 sentences]\n\n';
      finalPrompt += 'II. WHY IT MATTERS\n[List ALL reasons. Walang limit.]\n\n';
      finalPrompt += 'III. IMPACT\n[List ALL impacts. Walang limit.]\n\n';
      finalPrompt += 'IV. CONCLUSION\n[1-2 sentences]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else if (intent === 'effects') {
      finalPrompt += 'TASK: Explain the EFFECTS COMPLETELY.\n\n';
      finalPrompt += 'FORMAT:\n\n';
      finalPrompt += 'I. INTRODUCTION\n[1-2 sentences]\n\n';
      finalPrompt += 'II. POSITIVE EFFECTS\n[List ALL positive effects. Walang limit.]\n\n';
      finalPrompt += 'III. NEGATIVE EFFECTS\n[List ALL negative effects. Walang limit.]\n\n';
      finalPrompt += 'IV. BALANCED VIEW\n[2-3 sentences]\n\n';
      finalPrompt += 'V. CONCLUSION\n[1-2 sentences]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
      ...
      finalPrompt += 'III. EDUCATION\n[2-3 sentences]\n\n';
      finalPrompt += 'IV. CAREER\n[2-3 sentences]\n\n';
      finalPrompt += 'V. MAJOR CONTRIBUTIONS\n[List ALL contributions. Walang limit.]\n\n';
      finalPrompt += 'VI. KEY FACTS\n[List ALL key facts. Walang limit.]\n\n';
      finalPrompt += 'VII. SIGNIFICANCE\n[2-3 sentences]\n\n';
      finalPrompt += 'VIII. CONCLUSION\n[1-2 sentences]\n\n';
      finalPrompt += 'QUESTION: ' + prompt + '\n\nDetailed answer:';
    } else {
  ...
  buildLogicPrompt(prompt, langName) {
    ...
    finalPrompt += '3. Do NOT hallucinate. If the question is unclear, say so.\n';
    ...
    finalPrompt += '10. Keep it CONCISE and ACCURATE.\n';
    finalPrompt += '11. NO emojis, NO markdown, NO LaTeX.\n\n';
    finalPrompt += 'FORMAT:\nLogic Answer\n\nI. REASONING\n[Step-by-step reasoning]\n\nII. ANSWER\n[Final answer]\n\n';
  ...
  ensureComplete(text) {
    ...
    // REMOVE DUPLICATE FINAL ANSWERS
    const finalAnswerMatch = cleaned.match(/Final Answer:\s*([\d\.\-\+\/]+)/i);
    if (finalAnswerMatch) {
      const finalNum = finalAnswerMatch[1].trim();
      cleaned = cleaned.replace(new RegExp('^' + finalNum.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '\\s*\\n+', 'i'), '');
    }
    ...
    const isMath = /step\s+\d|÷|×|\d\s*[\+\-\*\/]\s*\d|final answer/i.test(cleaned);
    if (isMath && !/final answer/i.test(cleaned)) {
      const mathExpr = cleaned.match(/(\d[\d\s\+\-\*\/÷×\(\)\.]+)/);
      if (mathExpr) {
        try {
  ...
  isFollowUpRequest(prompt) {
    const keywords = ['elaborate', 'explain more', 'paki elaborate', 'paliwanag', 'ipaliwanag', 'detail', 'further', 'more details', 'simplify', 'simple', 'example', 'sample', 'halimbawa', 'correct', 'fix', 'tama', 'add', 'dagdagan', 'more', 'formalize', 'ulit', 'repeat'];
