// ========== ai.js - COMPLETE AI ASSISTANT v36.0.0 ==========
// Pollinations AI REMOVED. 4 working APIs. All functions intact.
...
module.exports = {
  ...
  async execute(senderId, args, token, event) {
    try {
      ...
      try {
        ...
        console.log('[AI] callAPI failed, trying fallback...');
  ...
  // ============================================================
  // CALL API — 4 APIs, walang Pollinations
  // ============================================================
  async callAPI(prompt, originalPrompt, language, intent, topic, subject, requestType) {
    const apiConfigs = [
      ...
      // Pollinations AI — REMOVED (laging credit error)
    ...
    for (const config of apiConfigs) {
      try {
        ...
        // Return agad kapag >= 70
        if (quality.isGood && quality.score >= 70) {
  ...
  // ============================================================
  // FALLBACK API — retry lahat ng 4 APIs
  // ============================================================
  async callAPIFallback(prompt, originalPrompt, language, intent, topic, subject, requestType) {
    ...
    const errorKeywords = ['not enough credits', 'low balance', 'top up', 'credits', 'balance', 'api key', 'quota', 'exceeded'];
