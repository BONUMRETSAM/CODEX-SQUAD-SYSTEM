// ========== ai.js - COMPLETE AI ASSISTANT v33.0.0 ==========
// Best-Output Guarantee: Completeness, Accuracy, Relevance
...
module.exports = {
  ...
  description: 'Complete AI assistant with best-output guarantee',
  ...
  // ============================================================
  // CALL API — CHOOSE HIGHEST QUALITY
  // ============================================================
  ...
  // ============================================================
  // VALIDATE RESPONSE QUALITY — STRICT
  // ============================================================
  validateResponseQuality(response, intent) {
    ...
    const briefIntents = ['definition', 'general', 'explanation', 'process', 'list', 'comparison', 'howto', 'proscons', 'importance', 'effects', 'biography', 'wordlist', 'translation', 'followup', 'elaborate', 'summarize', 'paraphrase', 'simplify', 'expand', 'translate', 'correct', 'humanize', 'formalize', 'construct', 'definition_process'];
    if (briefIntents.includes(intent) && response.length > 3000) {
      score -= 30;
    }
  ...
  buildDefinitionProcessPrompt(prompt, langName) {
    ...
    finalPrompt += '6. Be COMPREHENSIVE. Cover ALL stages/phases/steps. Do NOT stop at 3 items. Give the COMPLETE picture.\n';
    finalPrompt += '7. Be TUMPAK (accurate). If a stage/step is unclear, be specific and detailed.\n';
  ...
  buildBriefPrompt(prompt, langName, intent) {
    ...
    finalPrompt += '6. Do NOT hallucinate. Be ACCURATE and PRECISE. Verify each fact before writing.\n';
