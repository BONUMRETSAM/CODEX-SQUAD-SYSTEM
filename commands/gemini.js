...
module.exports = {
  ...
  async execute(senderId, args, token, event) {
    try {
      ...
      // ===== STEP 5: Final cleanup (NO DUPLICATES) =====
  ...
  finalCleanup(response, wantsSolution) {
    ...
    for (const line of lines) {
      ...
      if (numMatch) {
        ...
        // Non-numbered line - check for duplicates
    ...
    // 6. Add "Answer:" prefix ONLY ONCE at the start
  ...
  // ============================================================
  // VERIFY AND COMPLETE (NO DUPLICATES)
  // ============================================================
...
- Respond in ${langName.toUpperCase()} language.`;
      ...
      try {
        ...
        // Remove "Answer:" prefix from missing answers before appending
...
3. [Answer]`;
    ...
    prompt += `\n\nNOW ANSWER ALL QUESTIONS ABOVE.`;
...
- Respond in ${langName.toUpperCase()} language.`;
  ...
  // ============================================================
  // CLEAN RESPONSE (NO "Answer:" PREFIX ADDED)
  // ============================================================
  cleanResponse(response) {
    ...
    // DO NOT add "Answer:" prefix here - it will be added in finalCleanup
    return cleaned;
  },
  ...
  async sendAllChunks(senderId, text, token) {
    ...
    for (let i = 0; i < chunks.length; i++) {
      ...
      // Remove "Answer:" prefix from non-first chunks
      if (i > 0) {
